...
from .views import friendship_api, friendships_api, genre_api, genres_api, login_site_user, logout_site_user, review_api, reviews_api, signup_site_user, books_api, book_api, site_users_api, site_user_api, user_book_api, user_books_api
