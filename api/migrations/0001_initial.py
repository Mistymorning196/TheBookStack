# Generated by Django 5.1.1 on 2025-04-03 11:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('book', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.book')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.author')),
            ],
        ),
        migrations.CreateModel(
            name='AuthorBlog',
        ...
        migrations.AddField(
            model_name='author',
            name='blogs',
            field=models.ManyToManyField(through='api.AuthorBlog', to='api.blog'),
        ),
        migrations.AddField(
            model_name='author',
            name='books',
            field=models.ManyToManyField(related_name='authors', through='api.AuthorBook', to='api.book'),
        ),
        migrations.CreateModel(
            name='UserBook',
            fields=[
